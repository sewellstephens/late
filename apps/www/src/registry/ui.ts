...
export const ui: Registry = [
  ...
  {
    dependencies: ['@sewellstephens/plate-cloud'],
    files: [
      'plate-ui/cloud.tsx',
  ...
  {
    dependencies: ['@sewellstephens/plate-code-block'],
    files: [
  ...
  {
    dependencies: ['@sewellstephens/plate-layout'],
  ...
  {
    dependencies: ['@sewellstephens/plate-comments'],
    files: [
  ...
  {
    dependencies: ['@sewellstephens/plate-emoji'],
  ...
  {
    dependencies: ['@sewellstephens/plate-alignment'],
  ...
  {
    dependencies: ['@sewellstephens/plate-block-quote'],
  ...
  {
    dependencies: ['@sewellstephens/plate-caption'],
  ...
  {
    dependencies: ['@sewellstephens/plate-basic-marks'],
  ...
  {
    dependencies: ['@sewellstephens/plate-excalidraw'],
  ...
  {
    dependencies: ['@sewellstephens/plate-floating'],
  ...
  {
    dependencies: ['@sewellstephens/plate-heading'],
  ...
  {
    dependencies: ['@sewellstephens/plate-highlight'],
  ...
  {
    dependencies: ['@sewellstephens/plate-horizontal-rule'],
  ...
  {
    dependencies: ['@sewellstephens/plate-media'],
  ...
  {
    dependencies: ['@sewellstephens/plate-indent-list'],
  ...
  {
    dependencies: ['@sewellstephens/plate-indent'],
  ...
  {
    dependencies: ['@ariakit/react', '@sewellstephens/plate-combobox'],
  ...
  {
    dependencies: ['@sewellstephens/plate-block-quote', '@sewellstephens/plate-heading'],
  ...
  {
    dependencies: ['@sewellstephens/plate-kbd'],
  ...
  {
    dependencies: ['@sewellstephens/plate-line-height'],
  ...
  {
    dependencies: ['@sewellstephens/plate-link'],
  ...
  {
    dependencies: ['@sewellstephens/plate-list'],
  ...
  {
    dependencies: ['@sewellstephens/plate-mention'],
  ...
  {
    dependencies: ['@sewellstephens/plate-find-replace'],
  ...
  {
    dependencies: ['@sewellstephens/plate-heading', '@sewellstephens/plate-indent-list'],
  ...
  {
    dependencies: ['@sewellstephens/plate-table'],
  ...
  {
    dependencies: ['@sewellstephens/plate-toggle'],
  ...
  {
    dependencies: ['@sewellstephens/plate-resizable'],
