...
export const ui: Registry = [
  ...
  {
    dependencies: ['@sewell_stephens/late-cloud'],
    files: [
      'plate-ui/cloud.tsx',
  ...
  {
    dependencies: ['@sewell_stephens/late-code-block'],
    files: [
  ...
  {
    dependencies: ['@sewell_stephens/late-layout'],
  ...
  {
    dependencies: ['@sewell_stephens/late-comments'],
    files: [
  ...
  {
    dependencies: ['@sewell_stephens/late-emoji'],
  ...
  {
    dependencies: ['@sewell_stephens/late-alignment'],
  ...
  {
    dependencies: ['@sewell_stephens/late-block-quote'],
  ...
  {
    dependencies: ['@sewell_stephens/late-caption'],
  ...
  {
    dependencies: ['@sewell_stephens/late-basic-marks'],
  ...
  {
    dependencies: ['@sewell_stephens/late-excalidraw'],
  ...
  {
    dependencies: ['@sewell_stephens/late-floating'],
  ...
  {
    dependencies: ['@sewell_stephens/late-heading'],
  ...
  {
    dependencies: ['@sewell_stephens/late-highlight'],
  ...
  {
    dependencies: ['@sewell_stephens/late-horizontal-rule'],
  ...
  {
    dependencies: ['@sewell_stephens/late-media'],
  ...
  {
    dependencies: ['@sewell_stephens/late-indent-list'],
  ...
  {
    dependencies: ['@sewell_stephens/late-indent'],
  ...
  {
    dependencies: ['@ariakit/react', '@sewell_stephens/late-combobox'],
  ...
  {
    dependencies: ['@sewell_stephens/late-block-quote', '@sewell_stephens/late-heading'],
  ...
  {
    dependencies: ['@sewell_stephens/late-kbd'],
  ...
  {
    dependencies: ['@sewell_stephens/late-line-height'],
  ...
  {
    dependencies: ['@sewell_stephens/late-link'],
  ...
  {
    dependencies: ['@sewell_stephens/late-list'],
  ...
  {
    dependencies: ['@sewell_stephens/late-mention'],
  ...
  {
    dependencies: ['@sewell_stephens/late-find-replace'],
  ...
  {
    dependencies: ['@sewell_stephens/late-heading', '@sewell_stephens/late-indent-list'],
  ...
  {
    dependencies: ['@sewell_stephens/late-table'],
  ...
  {
    dependencies: ['@sewell_stephens/late-toggle'],
  ...
  {
    dependencies: ['@sewell_stephens/late-resizable'],
