...
[Playwright](https://playwright.dev/) enables end-to-end testing in headless browsers. This guide covers integrating Playwright with Plate using `@sewellstephens/plate-playwright`.
...
```bash
npm install @sewellstephens/plate-playwright playwright
```
