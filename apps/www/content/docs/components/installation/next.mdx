...
A <Link href="https://github.com/sewellstephens/late/tree/main/templates/plate-template">template</Link> is available to help you get started quickly.
...
```bash
npx @sewellstephens/plate-ui@latest add button
```
