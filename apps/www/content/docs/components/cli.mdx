...
```txt
Usage: @sewellstephens/plate-ui init [options]
...
```txt
Usage: @sewellstephens/plate-ui add [options] [components...]
...
```bash
npx @sewellstephens/plate-ui@latest diff
```
...
```bash
npx @sewellstephens/plate-ui@latest diff blockquote-element
```
...
```txt
Usage: @sewellstephens/plate-ui diff [options] [component]
