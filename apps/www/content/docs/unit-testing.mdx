...
This guide outlines best practices for unit testing Plate plugins and components using `@sewellstephens/plate-test-utils`.

## Installation

```bash
npm install @sewellstephens/plate-test-utils slate-hyperscript
```
