...
```bash
npm install @sewellstephens/plate-dnd @sewellstephens/plate-node-id react-dnd react-dnd-html5-backend
```

## Usage

```tsx
import { DndPlugin } from '@sewellstephens/plate-dnd/react';
import { NodeId } from '@sewellstephens/plate-node-id';
