...
```bash
npm install @sewell_stephens/late-yjs
```

### Usage

```tsx
import { YjsPlugin } from '@sewell_stephens/late-yjs/react';
...
Higher-order function that wraps a Late editor with Yjs support, allowing for real-time collaborative editing.
