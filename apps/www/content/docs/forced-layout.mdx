...
```bash
npm install @sewellstephens/plate-normalizers @sewellstephens/plate-trailing-block
```

## Usage

```tsx
import { NormalizersPlugin } from '@sewellstephens/plate-normalizers/react';
import { TrailingBlockPlugin } from '@sewellstephens/plate-trailing-block/react';
import { ParagraphPlugin } from '@sewellstephens/plate-common/react';
import { HEADING_KEYS } from '@sewellstephens/plate-heading/react';
