...
```bash
npm install @sewell_stephens/late-normalizers @sewell_stephens/late-trailing-block
```

## Usage

```tsx
import { NormalizersPlugin } from '@sewell_stephens/late-normalizers/react';
import { TrailingBlockPlugin } from '@sewell_stephens/late-trailing-block/react';
import { ParagraphPlugin } from '@sewell_stephens/late-common/react';
import { HEADING_KEYS } from '@sewell_stephens/late-heading/react';
