...
```bash
npm install @sewellstephens/plate-docx @sewellstephens/plate-juice
```
...
Given pasted HTML, `@sewellstephens/plate-juice` is used to inline CSS properties into the `style` attribute.
