...
```bash
npm install @sewellstephens/plate-basic-elements
# or
npm install @sewellstephens/plate-block-quote @sewellstephens/plate-code-block @sewellstephens/plate-heading
```

## Usage

```tsx
import { BasicElementsPlugin, CodeBlockPlugin } from '@sewellstephens/plate-basic-elements/react';
