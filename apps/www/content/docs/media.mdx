...
- Editable captions.
- Resizable.
- Use [Late Cloud](/docs/cloud) for easy cloud uploads and server-side image resizing.
...
```bash
npm install @sewellstephens/plate-media
```
...
<APIParameters>
  ...
  <APIItem name="plugin" type="LatePlugin">
    The plate plugin.
  </APIItem>
</APIParameters>
