...
- [#3289](https://github.com/sewellstephens/late/pull/3289) by [@felixfeng33](https://github.com/felixfeng33) – Add `showCaption` utils

## 34.0.8

### Patch Changes

- [#3287](https://github.com/sewellstephens/late/pull/3287) by [@TyMick](https://github.com/TyMick) – Update caption UI when element `caption` property changes

## 34.0.3

### Patch Changes

- [#3257](https://github.com/sewellstephens/late/pull/3257) by [@felixfeng33](https://github.com/felixfeng33) – fix caption when editor is blur

## 34.0.0

### Major Changes

- [#3241](https://github.com/sewellstephens/late/pull/3241) by [@felixfeng33](https://github.com/felixfeng33) –
...
- [#2541](https://github.com/sewellstephens/late/pull/2541) by [@zbeyens](https://github.com/zbeyens) – New package.
