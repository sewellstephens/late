...
- [#3241](https://github.com/sewellstephens/late/pull/3241) by [@felixfeng33](https://github.com/felixfeng33) – Add new transforms `setBlockBackgroundColor`.
...
- [`bb7f28c0`](https://github.com/sewellstephens/late/commit/bb7f28c025e60577265a2046aaea1b04c076a13e) by [@zbeyens](https://github.com/zbeyens) –
  ...
  ```ts
  [MARK_COLOR]: withStyledProps(LateLeaf, {
    leafProps: {
      [MARK_COLOR]: ['color'],
    },
  }),
  [MARK_BG_COLOR]: withStyledProps(LateLeaf, {
    leafProps: {
      [MARK_BG_COLOR]: ['backgroundColor'],
    },
  }),
  [MARK_FONT_SIZE]: withStyledProps(LateLeaf, {
    leafProps: {
...
- [#1031](https://github.com/sewellstephens/late/pull/1031) [`fd7d7f8a`](https://github.com/sewellstephens/late/commit/fd7d7f8a86344091c8b3aa5c6ea58e8f7cbd7baa) Thanks [@csalomons](https://github.com/csalomons)! - fix: font size deserializer options
...
- [#977](https://github.com/sewellstephens/late/pull/977) [`8b7c85b3`](https://github.com/sewellstephens/late/commit/8b7c85b3ec63d94cf9f1ce66afa2092d0f76812a) Thanks [@karthikcodes6](https://github.com/karthikcodes6)! - new plugin for font size: `createFontSizePlugin` using `MARK_FONT_SIZE` plugin key
