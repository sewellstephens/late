...
- [#3330](https://github.com/sewellstephens/late/pull/3330) by [@yf-yang](https://github.com/yf-yang) – add diff-match-patch-ts as a dependency
...
- [#3011](https://github.com/sewellstephens/late/pull/3011) by [@12joan](https://github.com/12joan) –
...
- [#3009](https://github.com/sewellstephens/late/pull/3009) by [@12joan](https://github.com/12joan) –
...
- [#2984](https://github.com/sewellstephens/late/pull/2984) by [@12joan](https://github.com/12joan) – Fix: Node equivalency checking is incorrectly dependent on the key order of the node object

## 30.6.0

### Minor Changes

- [#2982](https://github.com/sewellstephens/late/pull/2982) by [@12joan](https://github.com/12joan) – `computeDiff`: Add `lineBreakChar?: string` option to replace `\n` characters in inserted and removed text with a character such as '¶'. Without this option, added or removed line breaks may be difficult to notice in the diff.
