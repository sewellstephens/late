...
- [#3226](https://github.com/sewellstephens/late/pull/3226) by [@mareksuscak](https://github.com/mareksuscak) – Fixed custom trailing block types
...
- [#2359](https://github.com/sewellstephens/late/pull/2359) by [@zbeyens](https://github.com/zbeyens) – 🐛 `type` option was not used
