...
- [#3427](https://github.com/sewellstephens/late/pull/3427) by [@yf-yang](https://github.com/yf-yang) – fix single line plugin normalization
...
- [#2471](https://github.com/sewellstephens/late/pull/2471) by [@zbeyens](https://github.com/zbeyens) – Fix: normalize only for the editor node.
...
- [#2129](https://github.com/sewellstephens/late/pull/2129) by [@OliverWales](https://github.com/OliverWales) – adds a new option relative?: boolean to the exit break plugin that allows the exit point ("level" property) to be relative to the current level rather than absolute. It is optional and default false to not introduce any breaking change. Also adds a passing fix to a doc typo. This allows the exit break plugin to be useful in editors with nested blocks e.g. tables (fixes #2128)
...
- [#1488](https://github.com/sewellstephens/late/pull/1488) by [@suchanlee](https://github.com/suchanlee) – prevent double new lines when pressing enter with soft/exit break plugins
...
- [#1429](https://github.com/sewellstephens/late/pull/1429) by [@zbeyens](https://github.com/zbeyens) –
...
- [#969](https://github.com/sewellstephens/late/pull/969) [`0e5050ba`](https://github.com/sewellstephens/late/commit/0e5050ba0ca7862a535712a49c2eeb29c5337b5d) Thanks [@vimtor](https://github.com/vimtor)! - New plugin: single line editor where extra lines get removed instead of trying to merge them.
