...
- [#1414](https://github.com/sewellstephens/late/pull/1414) by [@dtslvr](https://github.com/dtslvr) – Support case-insensitive matching

## 10.2.3

### Patch Changes

- [#1426](https://github.com/sewellstephens/late/pull/1426) by [@nemanja-tosic](https://github.com/nemanja-tosic) – Fix find replace not highlighting search term
